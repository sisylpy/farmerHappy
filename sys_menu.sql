...
INSERT INTO `sys_menu` VALUES (62, 53, '供货商列表', 'Distributer', 'ckDistributer:list, ckDistributer:info, ckDistributer:save, ckDistributer:update, ckDistributer:delete', 1, 'fa fa-cog', 1);
